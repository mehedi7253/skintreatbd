            ...
            <div class="col-md-12 mx-auto mt-5 mb-5">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h3 class="text-center">Message Mission</h3>
                    </div>
                    <div class="card-body">
                        <?php
                            ...
                            <table class="table table-bordered">
                                ...
                                while ($row = mysqli_fetch_assoc($res)){?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="Edit_Mission.php?mission=<?php echo $row['ID'];?>"  class="btn btn-info">Edit</a>
                                            <a href="delete.php?mission=<?php echo $row['ID'];?>"  class="btn btn-danger" onclick="return confirm('Are You Sure To Delete...!')">Delete</a>
                                        </td>
                                    </tr>
                                <?php }?>
                                </tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title" id="formModal"> Mission Description</h5>
