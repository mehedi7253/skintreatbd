                            ...
                            <table class="table table-bordered">
                                ...
                                while ($row = mysqli_fetch_assoc($res)){?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <img src="../images/<?php echo $row['image'];?>" class="img-fluid" style="height: 50px; width: 70px">
                                        </td>
                                        <td>
                                            <?php
                                            $status = $row['status'];
                                            if (($status) == '0'){?>
                                                <a href="bloc_unblock.php?status=<?php echo $row['id'];?>" class="btn btn-success" onclick="return confirm('Are You Sure To Block')">Un Block</a>
                                                <?php
                                            }
                                            if (($status) == '1'){?>
                                                <a href="bloc_unblock.php?status=<?php echo $row['id'];?>" class="btn btn-danger" onclick="return confirm('Are You Sure To Un-Block')"> Block</a>
                                                <?php
                                            }
                                            ?>
                                        </td>
