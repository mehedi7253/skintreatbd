            ...
            <div class="col-md-10 mx-auto mt-5 mb-5">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h3 class="text-center">Add Mission</h3>
                    </div>
                    <div class="card-body">
                        <h3>
                            <?php
                            if (isset($_POST['btn'])){
                                ...
                                if ($l_desc == '')
                                {
                                    ...
                                    $service = "INSERT INTO mission (Description) VALUES ('$l_desc')";
                                    $res_serv = mysqli_query($connect, $service);

                                    if ($res_serv){
                                        $_SESSION['success'] = 'Mission Added Successful';
                                    }else{
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label> Missions<sup class="text-danger font-weight-bold">*</sup></label>
                                <textarea name="Description" id="Description" class="form-control" placeholder="Enter Brief Description"></textarea>
                            </div>
