        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="main_nav">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <?php echo $userdata['name'];?>  <img src="../images/Capture.JPG" style="height: 30px; width: 30px; border-radius: 50%">
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <div class="col-md-10 mx-auto mt-5 mb-5">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h3 class="text-center">Update About Us</h3>
                    </div>
                    <div class="card-body">
                        <h3>
                            <?php
                            if (isset($_GET['aboutus'])){
                                ...
                                $sql = "SELECT * FROM aboutus WHERE about_us_id = '$id'";
                            ...
                            if (isset($_POST['btn'])){
                                ...
                                $about_up= "UPDATE aboutus SET  Description = '$Desc' WHERE about_us_id = '$about_ID'";
                                $res_serv = mysqli_query($connect, $about_up);

                                if ($res_serv){
                                    $_SESSION['success'] = 'About Us Updated Successful';

                                    echo "<script>document.location.href='Manage_AboutUs.php'</script>";
                                }else{
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                            <input type="" name="ID" value="<?php echo $data['about_us_id'];?>" hidden>
                                <label> Description<sup class="text-danger font-weight-bold">*</sup></label>
                                <textarea name="Description" id="application" class="form-control" placeholder="Enter Brief Description"><?php echo $data['Description'];?></textarea>
                            </div>
                            <div class="form-group">
