            ...
            <div class="col-md-8 mx-auto mt-5 mb-5">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h3 class="text-center">Update Contact Address</h3>
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        if (isset($_GET['contact'])){
                            ...
                            $sql_get = "SELECT * FROM contatc_info WHERE id = $id";
                        ...
                        if (isset($_POST['btn']))
                        {
                            ...
                            if ($address == ''){
                                ...
                                $sql = "UPDATE contatc_info SET address = '$address', phone = '$phone', email = '$email' WHERE id = $id";
                                $res = mysqli_query($connect, $sql);

                                if ($res){
                                    echo "<script>document.location.href='edit_contact.php?contact=$id'</script>";
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Address</label>
                                <input type="number" name="id" hidden class="form-control" value="<?php echo $data['id'];?>" placeholder="Enter Phone Number">
                                <textarea class="form-control" name="address" placeholder="Enter Address"><?php echo $data['address'];?></textarea>
                            </div>
                            <div class="form-group">
                                <label>Enter Phone Number</label>
                                <input type="number" name="phone" class="form-control" value="<?php echo $data['phone'];?>" placeholder="Enter Phone Number">
                            </div>
                            <div class="form-group">
                                <label>Enter Contact Email</label>
                                <input type="email" name="email" class="form-control" value="<?php echo $data['email'];?>" placeholder="Enter Contact Email">
                            </div>
                            <div class="form-group">
                                <label></label>
                                <input type="submit" name="btn" class="btn btn-success" value="Update Now">
                            </div>
                        </form>
                    </div>
                </div>
