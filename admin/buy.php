            ...
            <div class="col-md-12 col-md-12 mt-5 mb-5">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h3 class="text-center">Buy List</h3>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                <?php
                                $sql = "SELECT * FROM cart, services WHERE cart.service_id = services.service_id";
                                ...
                                while ($row = mysqli_fetch_assoc($res)){?>
                                    <tr>
                                        ...
                                        <td style="width: 170px"><?php echo $row['title'];?></td>
                                        <td><?php echo $row['quantity'];?></td>
                                        <td><?php echo number_format($row['quantity'] * $row['price'], 2);?>T.k</td>
