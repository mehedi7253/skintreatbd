            ...
            <div class="col-md-12 mx-auto mt-5 mb-5">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h3 class="text-center">Message Services</h3>
                    </div>
                    <div class="card-body">
                        <?php
                            ...
                            <table class="table table-bordered">
                                ...
                                while ($row = mysqli_fetch_assoc($res)){?>
                                    <tr>
                                        ...
                                        <td style="width: 300px"><?php echo $row['short_desc'];?></td>
                                        <td><?php echo number_format($row['price'], 2);?> T.K</td>
                                        <td class="text-center">
                                            <a href='#description' data-toggle='modal' class='btn btn-info btn-sm btn-flat desc' data-id='<?php echo $row['service_id'];?>'><i class='fa fa-eye'></i> View</a>
                                        </td>

                                        <td><img src="../images/<?php echo $row['image'];?>" style="height: 50px; width: 50px"></td>
                                        <td>
                                            <a href="edit.php?service=<?php echo $row['service_id'];?>"  class="btn btn-info">Edit</a>
                                            <a href="delete.php?service=<?php echo $row['service_id'];?>"  class="btn btn-danger" onclick="return confirm('Are You Sure To Delete...!')">Delete</a>
                                        </td>
                                    </tr>
                                <?php }?>
                                </tbody>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title" id="formModal"> Service Description</h5>
