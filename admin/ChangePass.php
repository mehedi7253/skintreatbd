                ...
                <div class="card mt-5 mb-5">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['change_pass'])){
                            ...
                            $has_pass = hash('md5', $old_pass);
                            $new_pass_hash = hash('md5', $new_pass);

                            if ($old_pass == ''){
                                echo "<span class='text-danger'>Type Your Current Password</span><br/>";
                            }
                            if ($new_pass == ''){
                            ...
                            if ($old_pass && $has_pass){
                                $sql = "SELECT * FROM admin WHERE id = '$userdata[id]' AND password = '$has_pass'";
                                $result = mysqli_query($connect, $sql);

                                $up = mysqli_fetch_assoc($result);

                                if ($up !=0){
                                    $change_pass = "UPDATE admin SET password = '$new_pass_hash' WHERE id = '$userdata[id]'";
                       ...
                       <form action="" method="post">
                           <div class="form-group">
                               <label>Current Password <sup class="text-danger font-weight-bold">*</sup></label>
                               <input type="password" name="old_pass" class="form-control" placeholder="Enter Your Current Password">
                           </div>
                           <div class="form-group">
                               <label>New Password <sup class="text-danger font-weight-bold">*</sup></label>
                               <input type="password" name="password" class="form-control" placeholder="Enter Your New Password">
                           </div>
                           <div class="form-group">
                               <input type="submit" name="change_pass" class="btn btn-success" value="Submit">
                           </div>
                       </form>
                    </div>
                </div>
