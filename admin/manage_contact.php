            ...
            <div class="col-md-12 mx-auto mt-5 mb-5">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h3 class="text-center">Manage Contact Address</h3>
                    </div>
                    <div class="card-body">
                        <?php
                        ...
                        <div class="table-responsive">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <?php
                                $select_slider = "SELECT * FROM contatc_info";
                                ...
                                while ($row = mysqli_fetch_assoc($result)){?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_contact.php?contact=<?php echo $row['id'];?>" class="btn btn-info">Edit</a>
                                            <a href="delete.php?delete_contact=<?php echo $row['id'];?>" onclick="return confirm('Are You Sure To Delete...!')" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
