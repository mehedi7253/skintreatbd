                ...
                <div class="card mt-5 mb-5">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['pic'])){
                            ...
                            $update_profie_pic = "UPDATE admin SET image = '$location' WHERE id = '$userdata[id]'";
                            mysqli_query($connect, $update_profie_pic);


                            $sql = "SELECT * FROM admin WHERE id = '$userdata[id]'";
                            ...
                            if ($count == 1) {
                                ...
                                echo "<script>document.location.href='update_profile_pic.php'</script>";
