                    ...
                    <div class="card-body">
                        <h3>
                            ...
                            if (isset($_POST['btn'])){
                                ...
                                $about_up= "UPDATE Mission SET  Description = '$Desc' WHERE ID = '$mission_ID'";
                                $res_serv = mysqli_query($connect, $about_up);

                                if ($res_serv){
                                    $_SESSION['success'] = 'Mission Updated Successful';

                                    echo "<script>document.location.href='ManageMission.php'</script>";
                                }else{
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                            <input type="" name="ID" value="<?php echo $data['ID'];?>" hidden>
