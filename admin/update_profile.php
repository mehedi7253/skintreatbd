                    ...
                    <div class="card-body">
                        ...
                        <?php
                            if (isset($_POST['btn']))
                            {
                                ...
                                if ($id && $name && $email){
//                                    $update = "UPDATE admin SET name = '$name', email = '$email' WHERE id = '$userdata[id]'";

                                    $update = "UPDATE admin SET name = '$name' WHERE id = '$userdata[id]'";
                        ...
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="Enter Your Name" value="<?php echo $userdata['name']?>">
                            </div>
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" name="email" disabled title="Email Not Changeable" class="form-control" placeholder="Enter Your Email" value="<?php echo $userdata['email']?>">
                            </div>
                            <div class="form-group">
