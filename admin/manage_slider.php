            ...
            <div class="col-md-8 mx-auto mt-5 mb-5">
                <div class="card mt-5 mb-5">
                    <div class="card-header">
                        <h3 class="text-center">Manage Slider</h3>
                    </div>
                    <div class="card-body">
                        <?php
                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                while ($row = mysqli_fetch_assoc($result)){?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="delete.php?delete_slider=<?php echo $row['id'];?>" onclick="return confirm('Are You Sure To Delete...!')" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
